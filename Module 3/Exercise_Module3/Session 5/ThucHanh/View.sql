...
-- IN
delimiter $$
create procedure get_cus_by_id(in cus_id int)
begin
	select * from customers where customers.customerNumber = cus_id;
end $$
delimiter ;
...
-- OUT
delimiter $$
create procedure get_cus_count_by_id(in in_city varchar(50), out total int)
begin
...
call get_cus_count_by_id('Lyon', @total);
select @total;
