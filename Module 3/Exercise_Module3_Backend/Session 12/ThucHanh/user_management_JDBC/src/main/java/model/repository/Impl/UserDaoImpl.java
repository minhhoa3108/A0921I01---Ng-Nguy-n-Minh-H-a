...
public class UserDaoImpl implements IUserDao {//Connect DB
    private String jdbcURL = "jdbc:mysql://localhost:3306/ss12_th_demo?useSSL=false";
    private String jdbcUsername = "root";
    private String jdbcPassword = "nnmhoa448@";
    ...
    public User getUserById(int id) {
        User user = null;
        try(Connection connection = getConnection();
            CallableStatement callableStatement = connection.prepareCall(SEARCH_USER_BY_ID_STORE)) {
