...
<body>
    ...
    <form action="/benhan?action=edit" method="post">
        <table>
            <input type="text" name="ma_benh_an" value="<c:out value="${benhan.ma_benh_an}"></c:out>" hidden>
            <input type="text" name="ma_benh_nhan" value="<c:out value="${benhan.ma_benh_nhan}"></c:out>" hidden>
            <tr>
                <td>Tên Bệnh Nhân:</td>
